...
qt:greaterThan(QT_MAJOR_VERSION, 4) {
    ...
    QDOC_MAINFILE = $$PWD/qmlsql.qdocconf
} else {
...
## for release
## HTML_DOC_PATH=$$[QT_INSTALL_DOCS]/qmlsql/
...
QHP_FILE = $$HTML_DOC_PATH/qmlsql.qhp
QCH_FILE = $$OUT_PWD/doc/qmlsql.qch
...
inst_html_docs.path = $$[QT_INSTALL_DOCS]/qmlsql/
...
all_examples.files += $$PWD/../examples/qmlsql/*
all_examples.files -= $$PWD/../examples/qmlsql/models/doc
all_examples.files -= $$PWD/../examples/qmlsql/query/doc

all_examples.path = $$[QT_INSTALL_EXAMPLES]/qmlsql/
